...
const m = {
                    ...
                    for (let i = 0, len = mob.length; i < len; ++i) {
                        if (
                            ...
                            if (tech.blockDmg) { //electricity
                                ...
                                ctx.fillStyle = `rgba(200,150,220, ${0.2 + 0.4 * Math.random()})`
                                ctx.strokeStyle = "#000";
    ...
    },
    {
        ...
        effect: () => {
            ...
            m.hold = function () {
                m.airSpeedLimit = 200 //5 * player.mass * player.mass
                m.FxAir = 0.016
                if (m.isHolding) {
                    m.drawHold(m.holdingTarget);
                    m.holding();
    ...
    {
        name: "⚡ sandevistan 💨",
        description: "use <strong class='color-f'>energy</strong> to <strong style='letter-spacing: 2px;'>stop time</strong><br><strong>+20%</strong> movement and <strong><em>fire rate</em></strong><br>generate <strong>12</strong> <strong class='color-f'>energy</strong> per second, best paired with <strong>💥 spas 15 🔥</strong>",
        set() {
