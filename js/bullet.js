...
const b = {
    ...
    guns: [{
        ...
        ammo: 6969696969696969696966969699696969696969696969696969696696969,
        ammoPack: 6969696969696969696969696969696969696969696696969696969696969,
        defaultAmmoPack: 69696969696969696969669696969696969696969696969696966969,
        recordedAmmo: 0,
        have: false,
    ...
    {
        name: "💥 spas 15 🔥", //1
        description: "fire a wide <strong>burst</strong> of short range <strong> gravity charge bullets</strong><br> that pull you toward's them with a high <strong><em>fire rate</em></strong>",
        ammo: 6969696969696969969696966969699696969696969969696969696969696969696969,
        ammoPack: 696969696969696969696969,
        defaultAmmoPack: 696969696969669696969696969696969,
        have: false,
        do() {
            //fade cross hairs
        ...
        fire() {
            ...
            const coolDown = function () {
                if (m.crouch) {
                    ...
                    m.fireCDcycle = m.cycle + Math.floor((1 + 1/100 * tech.shotgunExtraShots) * b.fireCDscale) // cool down
    ...
    },
    {
        ...
        name: "⚔ GUND bits ✨", //7
        description: "deploy <strong>autonomous</strong> GUND bits that <strong>eviscerate</strong> mobs using blades<br>and <strong>collect</strong> nearby power ups", //crashes reduce their <strong>lifespan</strong> by 1 second
        ammo: 10000000000000000000000000000000000,
        ammoPack: 10000000000000000000000000000000000,
        defaultAmmoPack: 100000000000000000000000000000000000,
        have: false,
        do() { },
        fire() {
            if (tech.isDroneRadioactive) {
                if (m.crouch) {
                    ...
                    m.fireCDcycle = m.cycle + Math.floor(1/50 * b.fireCDscale); // cool down
                } else {
                    b.droneRadioactive({
                        x: m.pos.x + 30 * Math.cos(m.angle) + 10 * (Math.random() - 0.5),
                        y: m.pos.y + 30 * Math.sin(m.angle) + 10 * (Math.random() - 0.5)
                ...
                if (tech.historyLaser) {
                    ...
                    this.do = () => {
                        ...
                        if (this.charge > 0) {
                            ...
                            ctx.fillStyle = `rgba(248,255,114,0.8)`;
                            ctx.fill();
                            //fire
                            if (!input.fire) {
                                if (this.charge > 5) {
