const tech = {
    ...
    tech: [{
        ...
        description: "<strong>+222</strong> maximum <strong class='color-h'>health</strong><br><strong>don't lose</strong> <strong class='color-h'>health</strong> after hard <strong>landings</strong>",
        maxCount: 1,
        count: 0,
        frequency: 1,
        frequencyDefault: 1,
    ...
    },
    {
        ...
        description: "<strong class='color-f'>energy</strong> protects you instead of <strong class='color-h'>health</strong><br>exponentially <strong>increased</strong> <strong class='color-defense'>defense</strong> <em>(insert some sussy number)</em>",
        maxCount: 1,
        count: 0,
        frequency: 1,
        frequencyDefault: 1,
        ...
        remove() {
            if (tech.isEnergyHealth) {
                ...
                m.health = Math.max(Math.min(m.maxHealth, m.energy), 10);
    ...
    },
    {
        ...
        description: "a <strong class='color-bot'>GUND bit</strong> uses <strong class='color-f'>energy</strong> to emit a <strong class='color-laser'>laser</strong> beam<br>that targets nearby mobs",
        maxCount: 9,
        count: 0,
        frequency: 1,
        frequencyDefault: 1,
    ...
    {
        name: "🎇 GUND bits ✨ upgrade",
        link: `<a target="_blank" href='https://en.wikipedia.org/wiki/Robot' class="link">laser-bot upgrade</a>`,
        description: "<strong>convert</strong> your bots to <strong>🎇 GUND bits ✨</strong><br><strong>+100%</strong> <strong class='color-d'>damage</strong>, efficiency, and range",
        maxCount: 20,
        count: 0,
        frequency: 3,
        frequencyDefault: 3,
        ...
        effect() {
            ...
            b.convertBotsTo("🎇 GUND bits ✨")
            for (let i = 0; i < bullet.length; i++) {
                if (bullet[i].botType === 'laser') bullet[i].isUpgraded = true
            }
            tech.setBotTechFrequency()
            tech.setTechFrequency("🎇 GUND bits ✨", 5)
        },
        remove() {
            if (this.count) {
                for (let i = 0; i < bullet.length; i++) {
    ...
    {
        name: "longer plasma blade",
        link: `<a target="_blank" href='https://en.wikipedia.org/wiki/Plasma_(physics)' class="link">plasma jet</a>`,
        description: `use ${powerUps.orb.research(2)}<br><strong>+150%</strong> <strong class='color-plasma'>plasma</strong> <strong>torch</strong> range`,
        isFieldTech: true,
        maxCount: 1,
        count: 0,
        frequency: 2,
    ...
    },
    {
        ...
        description: `<strong>+50%</strong> <strong>movement</strong> and <strong>jumping</strong><br><strong class='color-worm'>wormholes</strong> drain <strong>zero</strong> <strong class='color-f'>energy</strong>`,
        isFieldTech: true,
        maxCount: 1,
        count: 0,
        frequency: 2,
